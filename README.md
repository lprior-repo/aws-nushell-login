...
# Install with pure Nushell installer
./install.nu
...
- ✅ **Multi-Profile Support**: Switch between AWS profiles seamlessly
- ✅ **SSO Integration**: Full AWS Single Sign-On support
- ✅ **Profile-Specific Aliases**: Auto-generated shortcuts like `awsl-dev`, `awsl-prod`
- ✅ **Environment Export**: Export credentials as environment variables
- ✅ **Temporary Credentials**: Support for MFA and session tokens
- ✅ **Security Features**: Production safeguards and input validation
- ✅ **Pure Nushell**: Everything written in native Nushell
...
awsl production --sso        # SSO login to production
aws-login dev --temp         # Get temporary credentials

# Profile-specific shortcuts (auto-generated by installer)
awsl-dev                    # Quick login to development
awsl-staging                # Quick login to staging
awsl-prod                   # Quick login to production (with safety prompt)
awsl-sandbox                # Quick login to sandbox

# Status and management
aws-status                   # Check current credentials
aws-profiles                # List available profiles
aws-clear                   # Clear environment
```

## 🎯 Profile-Specific Aliases

The installer automatically generates convenient aliases based on your AWS configuration:

```nu
# Auto-generated based on your ~/.aws/config and ~/.aws/credentials
...
**📖 See [PROFILE_ALIASES_GUIDE.md](PROFILE_ALIASES_GUIDE.md) for comprehensive examples and customization patterns**
